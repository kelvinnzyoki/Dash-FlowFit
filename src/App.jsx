  ...
  const response = await fetch(
    `https://generativelanguage.googleapis.com/v1/models/gemini-1.5-flash:generateContent?key=${apiKey}`,
    {
      ...
      body: JSON.stringify({
        contents: [{
          role: "user",
          parts: [{ text: `You are a world-class SaaS growth marketer specializing in fitness technology. You write social media posts for FlowFit — an AI-powered fitness SaaS platform that generates personalized workout plans, tracks progress, and adapts to each user's goals. The platform offers a free trial. Write posts that are genuine, punchy, and drive conversions. Avoid clichés. Sound human. Use platform-specific best practices. Return ONLY the post text — no preamble, no quotes, no labels, no markdown backticks.\n\n${userPrompt}` }],
        }],
