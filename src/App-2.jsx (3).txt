    ...
    <main className="page-shell">
      ...
      <form className="panel form-stack" onSubmit={schedulePosts}>
        ...
        <label>
          ...
          <span className="hint">Your local time ({Intl.DateTimeFormat().resolvedOptions().timeZone}). Stored as UTC — cron fires correctly regardless of server timezone.</span>
